import 'package:appnode/controllers/databasehelper.dart';
import 'package:appnode/view/editProducts.dart';
...
class _DetailState extends State<Detail> {
  ...
  AlertDialog alertDialog = new AlertDialog(
    ...
    actions: <Widget>[
      new RaisedButton(
        child: new Text("Confirm",style: new TextStyle(color: Colors.black),),
        color: Colors.red,
        onPressed: (){
